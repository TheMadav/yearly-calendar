...
,paper=a4% papersize understandable by the geometry package; default: a4
,year=2020% base of the calender calculation
...
,titleColor=black
,monthBGcolor=blue,
,sundayColor=black!40
,saturdayColor=black!20
,showweeknumbers=true% default: false
,events={GesetzlicheFeiertage, Geburtstage, JewishHolidays}% events and periods (files with ending ".events")
...
%monthBGcolor=blue!30 % additional font definition
